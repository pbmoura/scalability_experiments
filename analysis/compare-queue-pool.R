...
#file_name1 <- './data/step2/single1_15.ad'
#file_name2 <- './data/step2/elastic1_15.ad'
#file_name3 <- './data/step2/elastic1_15.hand'
...
plot_over(wd, "workload", type="l", xlim=c(0,max(time_sec1, time_sec2)))
