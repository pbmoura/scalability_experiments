...
legend("topright", legend = c("queue USL", "queue single-step", "workload"), col=c("blue", "red", "black"), lty=1)
...
plot_over(wd, "workload", type="l", xlim=c(0,max(time_sec1, time_sec2)), ylim=c(0,max(wd$intervals[wd$intervals != Inf])))
legend("topright", legend = c("USL", "single-step", "workload"), col=c("blue", "red", "black"), lty=1)
